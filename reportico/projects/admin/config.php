...
define('SW_HTTP_URLHOST', "");
define('SW_DEFAULT_PROJECT', PROJECT_NAME);

// Project Title used at the top of menus
define('SW_PROJECT_TITLE',PROJECT_TITLE);
...
define('SW_DB_USER', DB_USER);
define('SW_DB_PASSWORD', DB_PASS);
define('SW_DB_HOST', DB_HOST);
define('SW_DB_DATABASE', DB_NAME);
}
